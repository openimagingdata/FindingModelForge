...
**Recommendation**: Extract helper methods within same file:
...
**Analysis**: [`app/cache.py`](app/cache.py:1) has repetitive get/set/delete patterns for each entity:
...
**Potential Improvement**: Create generic typed cache wrapper:
...
**Analysis**: Current pattern is **CORRECT** per FastAPI best practices:
