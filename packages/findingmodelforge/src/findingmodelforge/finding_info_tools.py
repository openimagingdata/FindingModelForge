...
async def describe_finding_name(finding_name: str, model_name: str = DEFAULT_OPENAI_MODEL) -> BaseFindingInfo | Any:
...
async def get_detail_on_finding(
    finding: BaseFindingInfo, model_name: str = DEFAULT_PERPLEXITY_MODEL
