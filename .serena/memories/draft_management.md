...
## Overview
The FindingModelForge draft system provides autosave, resume, and submission functionality for finding model creation workflows. Drafts are stored in MongoDB with user isolation and action logging.
