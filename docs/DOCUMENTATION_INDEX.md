...
This document serves as a comprehensive index to all documentation in the FindingModelForge repository. Use this as a
reference guide for finding relevant documentation during development.
...
- **[.github/copilot-instructions.md](../.github/copilot-instructions.md)** - Concise project overview with
  documentation references for GitHub Copilot
...
- **[refactoring_plan_finding_model_creation.md](./refactoring_plan_finding_model_creation.md)** - System architecture
  evolution
