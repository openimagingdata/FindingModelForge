...
---
name: test-writer
description: Use PROACTIVELY after implementing new functions or modifying existing code. Creates comprehensive unit tests with mocking and fixtures.
...
The sub-agent should be able to work independently when invoked, without needing to ask for additional context about our project structure or conventions.
...
This approach creates focused, efficient sub-agents that understand our project's patterns without consuming excessive context tokens. Each agent becomes a specialist that can be invoked automatically by you when appropriate, or explicitly when I needs specific expertise.
